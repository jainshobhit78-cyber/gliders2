...
class GeneralSetting extends Model
{
    ...
    protected $fillable = [
        ...
        'launch_brand_title',
        'launch_brand_subtitle',
        'launch_intro_date_label',
        'launch_intro_overline',
        'launch_intro_whisper',
        'launch_ribbon_overline',
        'launch_ribbon_title',
        'launch_ribbon_highlight',
        'launch_ribbon_caption',
        'launch_countdown_overline',
        'launch_countdown_text_5',
        'launch_countdown_text_4',
        'launch_countdown_text_3',
        'launch_countdown_text_2',
        'launch_countdown_text_1',
        'launch_finale_overline',
        'launch_finale_title',
        'launch_finale_subtitle',
        'launch_finale_badge_text',
        'launch_animation_show_skip_button',
        'launch_animation_fireworks_enabled',
        'launch_animation_confetti_enabled',
        'eoi_enabled',
        'nav_font_size',
    ...
    protected $casts = [
        ...
        'launch_animation_show_skip_button' => 'boolean',
        'launch_animation_fireworks_enabled' => 'boolean',
        'launch_animation_confetti_enabled' => 'boolean',
        'eoi_enabled' => 'boolean',
