        ...
        <div class="card">
            ...
            <div class="tabs-menu">
                @if(auth()->guard('admin')->user()->can('vendors.view'))
                    <button class="tab-btn active" data-url="{{ url('admin/vendors/portal') }}">
                        Online Portal
                    </button>
                @endif
...
@section('script')
    ...
    <script>
        $(document).on("click", ".openPortalAdd", function () {
        ...
        $(document).on("click", ".openPortalEdit", function () {
        ...
        $(document).on("click", ".backPortal", function () {

            $.get("{{ url('admin/vendors/portal') }}", function (res) {
