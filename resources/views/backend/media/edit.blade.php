            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ url('admin/media/update/' . $playlist->id) }}" enctype="multipart/form-data"
                    ...
                    <div class="mb-3">
                        ...
                        <div id="thumbnailPreviewContainer" class="mt-2 {{ $playlist->thumbnail ? '' : 'd-none' }}">
                            <span class="text-muted d-block mb-1" id="thumbnailPreviewType">{{ $playlist->thumbnail ? 'Current Thumbnail:' : 'Autogenerated Preview:' }}</span>
                            <img src="{{ $playlist->thumbnail ? asset('uploads/media/images/' . $playlist->thumbnail) : '' }}" id="thumbnailPreviewImage" width="120" class="border rounded">
                        </div>
...
@section('script')
    ...
    <script>
        ...
        $(document).on('change', '.videoFile', function () {
            ...
            // Generate thumbnail if this is the first new video uploaded
