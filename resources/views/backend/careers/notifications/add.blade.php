...
<div class="container-fluid">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="post" action="{{ url('admin/careers/notifications/add') }}" enctype="multipart/form-data"
                class="theme-form">
                ...
                <div class="mb-4">
                    ...
                    <button type="button" id="addPdf" accept="application/pdf" class="btn btn-sm btn-primary mt-2">
