<div class="title-header d-flex align-items-center gap-3">
    ...
    <a href="javascript:void(0)" class="back-btn backInfo">
...
<div class="container-fluid">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="post" action="{{ url('admin/rti/information/update/' . $item->id) }}"
                ...
                <div class="mb-4">
                    ...
                    <label class="form-label-title">Info Text</label>

                    <textarea name="info_text" class="editor form-control" required>
