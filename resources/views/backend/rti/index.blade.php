...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="tabs-menu">
                @if(auth()->guard('admin')->user()->can('rti_officers.view'))
                    <button class="tab-btn active" data-url="{{ url('admin/rti/officers') }}">

                        RTI Officers

                    </button>
                @endif
                @if(auth()->guard('admin')->user()->can('rti_information.view'))

                    <button class="tab-btn" data-url="{{ url('admin/rti/information') }}">
...
@section('script')
    ...
    <script>
        $(document).on("click", ".openOfficerAdd", function () {
        ...
        $(document).on("click", ".openOfficerEdit", function () {
        ...
        $(document).on("click", ".backOfficer", function () {

            $.get("{{ url('admin/rti/officers') }}", function (res) {
    ...
    <script>
        $(document).on("click", ".openInfoAdd", function () {
        ...
        $(document).on("click", ".openInfoEdit", function () {
        ...
        $(document).on("click", ".backInfo", function () {

            $.get("{{ url('admin/rti/information') }}", function (res) {
