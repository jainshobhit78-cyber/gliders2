    ...
    <div class="login-wrapper">
        ...
        <div class="login-container">
            <div class="inner-header">
                ...
                <div class="inner-subtitle">OTP Verification</div>
            </div>
            ...
            <form method="POST" action="{{ url('admin/verify-otp') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="otp" name="otp" class="form-control" placeholder="000000" maxlength="6" required style="font-weight: bold; font-family: 'Share Tech Mono', monospace; letter-spacing: 4px; text-align: center; color: #2563eb; font-size: 16px;">
                    @error('otp')
                        <div class="error">{{ $message }}</div>
                    @enderror
                </div>
