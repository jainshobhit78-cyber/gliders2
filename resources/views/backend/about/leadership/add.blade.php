...
<div class="title-header d-flex align-items-center gap-3">
    ...
    <a href="{{ url('admin/about') }}" class="back-btn d-flex align-items-center">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="theme-form theme-form-2 mega-form" method="post"
                action="{{ url('admin/about/leadership/add') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="mb-4 row align-items-center">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="sub_title" class="form-control" placeholder="Enter Role Secondary"
                                required>
                        </div>
                    ...
                    <div id="milestone-wrapper">
                        ...
                        <div class="milestone-item border p-3 mb-3">
                            <div class="mb-3 d-flex align-items-center">
                                ...
                                <input type="date" name="milestones[0][start_date]" class="form-control  mb-2"
                                    placeholder="Start Date">
                            </div>

                            <div class="mb-3 d-flex align-items-center">
                                <label for="" class="col-sm-2">End Date</label>
                                <input type="date" name="milestones[0][end_date]" class="form-control  mb-2"
                                    placeholder="End Date">
                            </div>

                            <div class="mb-3 d-flex align-items-center">
                                <label for="" class="col-sm-2">Heading</label>
                                <input type="text" name="milestones[0][heading]" class="form-control mb-2"
                                    placeholder="Heading">
                            </div>
                    ...
                    <div class="px-2 w-100">
                        <button type="button" class="btn btn-success w-100 mb-3" onclick="addMilestone()">+ Add
                            Milestone</button>
                    </div>
