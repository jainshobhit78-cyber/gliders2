...
Route::middleware(['adminAuth', 'ipWhitelist'])->group(function () {
    ...
    Route::post('admin/settings/update', [SystemSettingsController::class, 'update'])->name('admin.settings.update');
    ...
    Route::get('admin/about/leadership/delete/{id}', [AboutLeadershipController::class, 'delete'])->middleware('permission:leadership.delete,admin');
    ...
    Route::get('admin/about/production-unit/delete-image/{id}', [AboutProductionUnitController::class, 'deleteImage'])->middleware('permission:production_unit.delete,admin');
    Route::get('admin/about/production-unit/delete/{id}', [AboutProductionUnitController::class, 'delete'])->middleware('permission:production_unit.delete,admin');
    ...
    Route::get('admin/about/history/delete/{id}', [AboutHistoryController::class, 'delete'])->middleware('permission:history.delete,admin');
    ...
    Route::get('admin/about/social-responsibility/delete/{id}', [AboutSocialResponsibilityController::class, 'delete'])->middleware('permission:social_responsibility.delete,admin');
    ...
    Route::get('admin/about/human-resources/delete/{id}', [AboutHumanResourcesController::class, 'delete'])->middleware('permission:human_resources.delete,admin');
    ...
    Route::get('admin/about/vision/delete/{id}', [AboutVisionController::class, 'delete'])->middleware('permission:vision.delete,admin');
    ...
    Route::get('admin/about/mission/delete/{id}', [AboutMissionController::class, 'delete'])->middleware('permission:mission.delete,admin');
    ...
    Route::get('admin/about/directory/delete/{id}', [AboutDirectoryController::class, 'delete'])->middleware('permission:directory.delete,admin');
    ...
    Route::get('admin/about/codes/delete/{id}', [AboutCodesConductController::class, 'delete'])->middleware('permission:codes_of_conduct.delete,admin');
    ...
    Route::get('admin/vigilance/cvo/delete/{id}', [VigilanceCvoController::class, 'delete'])->middleware('permission:chief_vigilance_officer.delete,admin');
    ...
    Route::get('admin/vigilance/setup/delete/{id}', [VigilanceSetupController::class, 'delete'])->middleware('permission:vigilance_setup.delete,admin');
    ...
    Route::get('admin/vigilance/contact/delete/{id}', [VigilanceContactController::class, 'delete'])->middleware('permission:vigilance_contact_details.delete,admin');
    ...
    Route::get('admin/vigilance/harassment/delete/{id}', [VigilanceSexualHarassmentController::class, 'delete'])->middleware('permission:sexual_harassment_of_women_at_workplace.delete,admin');
    ...
    Route::get('admin/vigilance/monitor/delete/{id}', [VigilanceMonitorController::class, 'delete'])->middleware('permission:independent_external_monitor.delete,admin');
    ...
    Route::get('admin/vigilance/manuals/delete/{id}', [VigilanceManualController::class, 'delete'])->middleware('permission:manuals_and_policies.delete,admin');
    ...
    Route::get('admin/vigilance/bulletin/delete/{id}', [VigilanceBulletinController::class, 'delete'])->middleware('permission:vigilance_bulletin.delete,admin');
    ...
    Route::get('admin/rti/officers/delete/{id}', [RTIOfficerController::class, 'delete'])->middleware('permission:rti_officers.delete,admin');
    ...
    Route::get('admin/rti/information/delete/{id}', [RTIInformationController::class, 'delete'])->middleware('permission:rti_information.delete,admin');
    ...
    Route::get('admin/careers/notifications/delete/{id}', [CareerNotificationController::class, 'delete'])->middleware('permission:careers.delete,admin');
    ...
    Route::get('admin/finance/reports/delete/{id}', [FinanceReportController::class, 'delete'])->middleware('permission:annual_reports.delete,admin');
    Route::get(
    ...
    Route::get('admin/finance/eoi/delete/{id}', [FinanceEoiController::class, 'delete'])->middleware('permission:eoi_for_banks.delete,admin');
    ...
    Route::get('admin/rajshabha/about/delete/{id}', [RajshabhaAboutController::class, 'delete'])->middleware('permission:rajshabha_about_us.delete,admin');
    ...
    Route::get('admin/rajshabha/niyam/delete/{id}', [RajshabhaNiyamController::class, 'delete'])->middleware('permission:niyam_pustak.delete,admin');
    ...
    Route::get('admin/rajshabha/rules/delete/{id}', [RajshabhaRulesController::class, 'delete'])->middleware('permission:rajshabha_rules.delete,admin');
    ...
    Route::get('admin/vendors/portal/delete/{id}', [VendorsPortalController::class, 'delete'])->middleware('permission:vendors.delete,admin');
    ...
    Route::get('admin/news/delete/{id}', [NewsController::class, 'delete'])->middleware('permission:news.delete,admin');
    ...
    Route::get('admin/category/delete/{id}', [ProductCategoryController::class, 'delete'])->middleware('permission:product_categories.delete,admin');
    ...
    Route::get('admin/product/delete/{id}', [ProductController::class, 'delete'])->middleware('permission:product.delete,admin');
